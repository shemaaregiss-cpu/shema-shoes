  ...
  return (
    ...
    <div className="bg-[#003366] text-[#F5DEB3] min-h-screen py-16 px-4 selection:bg-[#F5DEB3]/30 selection:text-[#003366]">
      <div className="max-w-4xl mx-auto flex flex-col gap-16">
        ...
        <div className="bg-white border border-white/60 rounded-2xl p-8 md:p-12 shadow-[0_25px_60px_rgba(0,51,102,0.35)] relative overflow-hidden">
          <div className="absolute top-0 left-0 right-0 h-1.5 bg-[#003366]" />

          <div className="flex items-center gap-4 mb-8 text-[#003366]">
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
              <circle cx="12" cy="12" r="3"></circle>
            </svg>
            <h1 className="text-2xl font-black uppercase tracking-widest text-[#003366]">
              Our Vision
            </h1>
          </div>
        ...
        <div className="bg-white border border-white/60 rounded-2xl p-8 md:p-12 shadow-[0_25px_60px_rgba(0,51,102,0.35)] relative overflow-hidden">
          ...
          <div className="flex items-center gap-4 mb-10 text-[#003366]">
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {salesTeam.map((member) => (
              <div
                key={member.id}
                className="bg-neutral-50 border border-neutral-200 rounded-xl overflow-hidden group shadow-md hover:border-[#003366] transition-all"
              >
                ...
                <div className="p-4 text-center bg-white">
                  <h3 className="font-black text-sm text-[#003366] uppercase tracking-wider mb-1">
                    {member.name}
                  </h3>
